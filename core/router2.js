...
class Router extends EventTarget {
  routes = [
    ...
    { path: 'invoice/overview', layout: 'standard', title: "Dashboard" , title: "Dashboard" },
    { path: 'invoice/details/:id', layout: 'standard' , title: "Dashboard" },
    { path: 'invoice/edit/:id', layout: 'standard' , title: "Dashboard" },

    { path: 'client/overview', layout: 'standard', title: "Übersicht" },
